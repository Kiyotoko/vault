...
1. 18 Jahre
2. $\Delta t=18\text{ Jahre}\times\sqrt{1- \frac{(0.5c)^{2}}{c^{2}}}=15.5885\text{ Jahre}$
3. $v=0.998456c$
4. 10 Jahre
5. 3 Lichtjahre
...
$v=c\sqrt{1-\big(\frac{m_{0}c^{2}}{qU+m_{0}c^{2}}\big)^{2}}=5.84568e7$
$v=c\sqrt{1-\big(\frac{m_{0}c^{2}}{qU+m_{0}c^{2}}\big)^{2}}=2.82291e8$
